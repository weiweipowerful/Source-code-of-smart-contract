...
site: https://usamcoin.com
x: https://x.com/usamcoincom
...
contract UsamCoin is ERC20, ERC20Burnable, Ownable {
    constructor(address recipient, address initialOwner)
        ERC20("Uncle Sam", "USAM")
        Ownable(initialOwner)
    {
        _mint(recipient, 313185200000 * 10 ** decimals());
    }
}