...
/**
Ten Fold is not affiliated with Twelve Fold.
*/
...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract TenFold is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor(string memory _uriPrefix) ERC721A("Ten Fold", "TNFLD") {
