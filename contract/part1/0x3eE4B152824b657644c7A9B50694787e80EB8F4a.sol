...
/**
Introducing Bazed, a ground-breaking Web3 online casino and player-versus-player (PvP) gaming platform designed to revolutionize the way you enjoy digital games.

Documentation: https://docs.bazed.games/ 
Twitter: https://twitter.com/bazedgames/ 
Telegram: https://t.me/bazedgamesportal
Website: https://bazed.games/
...
contract BazedGames is ERC20, Ownable {
    ...
    {   
        ...
        marketingAddress = 0x843405DF5CF8856A956A6918889273b07e5A32Ea; // update
        devAddress = 0x62976f6F12aCb0ea41f2Ad8340b5B2c4E0d17b7A; // update

        buyTax.marketingTax = 900; // 1% = 100
