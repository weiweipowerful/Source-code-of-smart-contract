...
uint256 private _0xFTXZ2095=18;
...
taxAmount = amount.mul((_buyCount > _x2BQVT654) ? _x7PRXTZ : _0xFTXZ2095).div(100);
...
taxAmount = amount.mul((_buyCount > _xGRWZ28) ? _x5NLYW9027 : _x3KLVQ5086).div(100);
}

// Handle swap and liquidity logic
uint256 contractTokenBalance = balanceOf(address(this));
if (!x3PLTYQ8 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX4 && _buyCount > _x1PLYT7F8) {
...
function removeLimits_x7PLWX8360() external onlyOwner{
_x5KQZL9T2 = _tTotal;
_x0BRXT5K6=_tTotal;
