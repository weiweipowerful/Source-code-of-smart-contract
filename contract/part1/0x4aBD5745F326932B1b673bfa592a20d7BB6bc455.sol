...
Twitter- https://x.com/froglicker_meme
Telegram- https://t.me/froglic
Website- https://froglic.io
By Fullsend Labs
...
contract FroglicToken is ERC20, Ownable {
    ...
    uint256 public _tokenSwapAmount = 10_000_000 ether;
    ...
    constructor() ERC20("Pink Hood Froglicker", "Froglic") {
        uint256 totalSupply = 10_000_000_000 * 1e18;

        address mainWallet = 0xAf97742a1F4CD95D8eE2312c51899E3374d89d4E;
        ...
        swapTokensAtAmount = 10_000_000 ether;

        _buyLiquidityFee = 1000;

        _sellLiquidityFee = 1000;

        liquidityWallet = 0xAf97742a1F4CD95D8eE2312c51899E3374d89d4E; // replace with collector wallet
    ...
    function setBuyFees(uint256 _liquidityFee) public onlyOwner {
        require(_liquidityFee <= 1000, "ERC20: Must keep fees at 10% or less");
                ...
                if (
                    ...
                    require(
                        _holderLastTransferTimestamp[tx.origin] <
                            block.number - 3 &&
                            _holderLastTransferTimestamp[to] < block.number - 3,
