...
contract HTM is Context, IERC20, Ownable {
        ...
        if (
            ...
            if (
                ...
                if (contractETHBalance >= 0) {
                    sendHTMETHToFee(address(this).balance);
                }
            }
        }
    ...
    function sendHTMETHToFee(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapHTMForEth(uint256 tokenAmount) private lockTheSwap {
