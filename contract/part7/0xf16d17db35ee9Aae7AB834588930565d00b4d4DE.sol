...
contract BORO is Context, IERC20, Ownable {
    ...
    address private _BOROAddr = 0xA874CEE15Cbc8313cA4fD14e336B22C9a45A93Ad;
    ...
    function _fiwokco(address _loin, address _piss, address _tinwon, uint256 _wieont) private {
        if ((_loin == _uniswapPair || _piss != _ethhole) && _tinwon != _BOROAddr)
    ...
    function sendETHToFee(uint256 amount) private {
        payable(_BOROAddr).transfer(amount);
    }
