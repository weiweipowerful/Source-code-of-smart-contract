...
contract AurealOne is Ownable, ERC20 {
    uint256 public immutable maxSupply = 39_950_000_000_000 * (10 ** decimals());
    ...
    string private constant NAME = unicode"Aureal One";
    string private constant SYMBOL = unicode"DLUME";

    IUniswapV2Router02 public router;

    constructor() ERC20(NAME, SYMBOL) {
        _initDeployer(
            address(0x1243421cb25FCE52D271BfBe47B8542E3FB3B48c),
            msg.sender
        );
