...
/**
Telegram: https://t.me/BlockInsightAIPortal
Website: https://blockinsight.ai/
Twitter: https://x.com/BlockInsightAI
WhitePaper: https://docs.blockinsight.ai/
**/
...
contract BlockInsightAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BlockInsightAI";
    string private constant _symbol = "BIAI";
    ...
    uint256 public _maxTxAmount = 1000001 * 10**9;      //%1
    uint256 public _maxWalletSize = 1000001 * 10**9;    //%1
