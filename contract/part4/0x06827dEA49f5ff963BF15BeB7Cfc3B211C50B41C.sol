...
contract TheCrypt is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 public MAX_TOTAL_PHASE = 2222;

    uint256 public MAX_PER_WALLET_FREE = 1;
    uint256 public MAX_PER_WALLET_WL = 9999;
    uint256 public MAX_PER_WALLET_OG = 9999;
    uint256 public MAX_PER_WALLET_PUBLIC = 9999;

    uint256 public freeSalePrice = 0 ether;
    uint256 public ogSalePrice = 0.019 ether;
    uint256 public wlSalePrice = 0.025 ether;
    ...
    ) ERC721A("TheCrypt", "CRYPT") PaymentSplitter(_team, _teamShares) Ownable(_initialOwner) {
        baseURI = _baseURI;
