...
/**
    ...
    Website:      https://sentai.info/
    Twitter:      https://x.com/SentAI_ETH
    Telegram:     https://t.me/SentAI_ETH
**/
...
contract SentAI is ERC20, Ownable {
    ...
    constructor() ERC20("SentAI", "SENTAI") {
        ...
        revShareWallet = address(0xF2ae345E06f5DaDEfCE769E4273D729491aB57f0); // set as MW wallet
        teamWallet = address(0x61849e17A41EE831aA5c9689C3680933EB07c94c); // set as Team wallet
    ...
    function updateBuyFees(
        ...
        buyTeamFee = _teamFee;
        buyTotalFees = buyRevShareFee + buyLiquidityFee + buyTeamFee;
        require(buyTotalFees <= 49, "Buy fees must be <= 49.");
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellRevShareFee + sellLiquidityFee + sellTeamFee;
        require(sellTotalFees <= 49, "Sell fees must be <= 49.");
    }
