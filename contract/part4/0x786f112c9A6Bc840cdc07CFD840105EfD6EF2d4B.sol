...
Ethereum Doge is a character created by the Ethereum Foundation and can be seen on their sites and socials.

https://t.me/EDogeERC

https://x.com/EDOGETOKEN
...
contract EDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ethereum Doge";
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (canSwap && !inSwap && from != uniswapV2Pair && swapEnabled && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                ...
                require(sellCount < maxsellsSum, "Block sell limit");
    ...
    function ZeroBot(address notbot) public onlyOwner {
        bots[notbot] = false;
    }
    ...
    function settingSellsPerBlockAmount(uint256 _maxsells) public onlyOwner {
        maxsellsSum = _maxsells;
    }
