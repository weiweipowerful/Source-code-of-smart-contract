...
/**
 ...
 TELEGRAM https://t.me/cybriacoin
 WEBSITE https://www.cybria.io/
...
contract CYBRIA is Context , IERC20, Ownable {
    ...
    string private constant _name = "CYBRIA" ;
    string private constant _symbol = "CYBA" ;
    uint256 public _maxTxAmount = 20000000 * 10**_decimals; // 2% of the supply
    uint256 public _maxWalletSize = 20000000 * 10**_decimals; // 2% of the supply
