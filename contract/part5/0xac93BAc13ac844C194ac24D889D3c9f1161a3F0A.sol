...
// File: contracts/MfersDoinStuff.sol

pragma solidity >=0.7.0 <0.9.0;

contract MfersDoinStuff is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 2069;
  ...
  constructor() ERC721("mfers doin stuff", "mfersdoin") {
    setHiddenMetadataUri("ipfs://QmdeVuvQBgNWoTLxKoHyWzJW9i5EHJNJBJrM9N6LyrMm4W/placeholder.gif");
  }
  ...
  function mint(uint256 _mintAmount, bytes32[] calldata proof) public payable mintCompliance(_mintAmount) {
    ...
    if (msg.sender != owner()) {
        ...
        if (onlyWhitelisted == true){
            require(verify(keccak256(abi.encodePacked(msg.sender)), proof), "Not Whitelisted User!");
        }
