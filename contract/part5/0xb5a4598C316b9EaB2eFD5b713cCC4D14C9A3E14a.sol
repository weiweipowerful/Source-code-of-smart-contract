...
contract CryptoTradingCards1880_1979 is IWCNFTErrorCodes, WCNFTMerkle, WCNFTToken, ERC721A {
    uint256 public constant MAX_SUPPLY = 837;
    ...
    constructor(address payable shareholderAddress_)
        ERC721A("Crypto Trading Cards (1880-1979)", "CARDS")
        WCNFTToken()
    {
