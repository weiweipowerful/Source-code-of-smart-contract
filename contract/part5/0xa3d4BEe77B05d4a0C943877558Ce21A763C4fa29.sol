...
uint128 constant TOTAL_SUPPLY = 12e15; // 12 billion tokens (6 decimals)
string constant NAME = "The Root Network";
string constant SYMBOL = "ROOT";
bytes32 constant MANAGER = keccak256("MANAGER");
bytes32 constant MULTISIG = keccak256("MULTISIG");

/**
 * @dev Futureverse ERC20 Root token
 */
contract RootToken is ERC20Capped, Pausable, AccessControl {
    ...
    function init(address _peg) external onlyRole(MANAGER) {
