 ...
 * https://acid-toad.com
 * https://t.me/acidtoadarmy
 * https://x.com/acidtoadarmy
 */
...
contract AcidToad is ERC20, Ownable {
    ...
    constructor() ERC20("Acid Toad", "TOAD") {
        IDexRouter _dexRouter = IDexRouter(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        exemptLimit(address(_dexRouter), true);
        ...
        exemptLimit(address(dexPair), true);
        ...
        marketingWallet = address(0x68D0B0b6b65B9a5db72222666E7a0ea52AA678E5);

        // exclude from paying fees or having max transaction amount
        feeExemptSet(msg.sender, true);
        feeExemptSet(address(this), true);
        feeExemptSet(address(0xdead), true);
        feeExemptSet(marketingWallet, true);

        exemptLimit(msg.sender, true);
        exemptLimit(address(this), true);
        exemptLimit(address(0xdead), true);
        exemptLimit(marketingWallet, true);
     ...
     */
    function newMaxLimitTx(uint256 _maxTx) external onlyOwner {
     ...
     */
    function feeNewBuy(uint256 _value) external onlyOwner {
        buyTaxTotal = _value;
     ...
     * @param _value The fee for the marketing wallet
     */
    function feeNewSell(uint256 _value) external onlyOwner {
        sellTaxTotal = _value;
        require(
            sellTaxTotal <= 100,
     ...
     */
    function feeNewWallet(address _marketing) external onlyOwner {
