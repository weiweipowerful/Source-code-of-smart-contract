...
contract TheBurgerz is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmVHHqWd1fgDJkx8V2nycCgGp6CejcXV8GthxMcja6PTXo/";
