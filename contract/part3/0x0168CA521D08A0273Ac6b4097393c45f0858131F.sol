...
/*
https://x.com/stoolpresidente/status/1902524401402122607

https://t.me/JackiePants
*/
...
contract TREND is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"JackiePants";
    string private constant _symbol = unicode"JACKIE";
    ...
    constructor () payable {
        _taxWallet = address(0x0032621d5fa54420db3f414db5cd4cb536731d74f7);
