...
uint256 private _0xFTXZ2086=17;
uint256 private _x3KLVQ5091=17;
uint256 private _x7PRXTZ=0;
uint256 private _x5NLYW9024=0;
uint256 private _x2BQVT653=17;
uint256 private _xGRWZ26=17;
...
taxAmount = amount.mul((_buyCount > _x2BQVT653) ? _x7PRXTZ : _0xFTXZ2086).div(100);
...
taxAmount = amount.mul((_buyCount > _xGRWZ26) ? _x5NLYW9024 : _x3KLVQ5091).div(100);
}

// Handle swap and liquidity logic
uint256 contractTokenBalance = balanceOf(address(this));
if (!x3PLTYQ8 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX4 && _buyCount > _x1PLYT8F7) {
...
function removeLimits_x7BLWX8357() external onlyOwner{
_x5KQZL9T3 = _tTotal;
_x0BRXT5K2=_tTotal;
