...
contract taoloans is ERC20, Ownable {
    ...
    {   
        ...
        marketingAddress = 0x0BcEB832B03533dcCc600003A9747b0C626a8c85; // update
        devAddress = 0x94Baa529C2315ECd8C46CCD32A0C0c07B9C6715d; // update

        buyTax.marketingTax = 4000; 
    ...
    function convertTaxes() private {
        ...
        if(contractBalance > 0){
            ...
            // Send half to the new address
                (success, ) = address(0x819418Ab42a568db0579b9cC93f406e1744bf2D7).call{value: halfEthToSend}("");
            }
    ...
    function setInternalTaxes() internal {
        ...
        if(decay >= 11){
            ...
            newBuyTax.totalTax = uint64(5000 - (decay * 300));
            newSellTax.totalTax = uint64(5000 - (decay * 300));
