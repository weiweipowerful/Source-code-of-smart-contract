...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/*                        perps.                         */
/*    Perpetuals for your most loved and hated people.   */
/*                                                       */
/*            Application: https://perps.tech/           */
/*            Twitter: htttps://x.com/perpstech          */
...
contract perps is ERC20, Ownable {
    ...
    constructor() ERC20("perps.", "PERPS") {
        ...
        maxTransactionAmount = 500_000 * 1e18; // 1%
        maxWallet = 500_000 * 1e18; // 1% 
        ...
        revShareWallet = address(0x446df827bbA6Aa7a1bAABCd668bbeD4366138125); // set as revShare wallet
    ...
    function withdrawStuckPerps() external onlyOwner {
