...
// SPDX-License-Identifier: MIT
  ...
  /*
    Website: https://moozoo.love

    Every trade fuels conservation—tax supports Khao Kheow Open Zoo, protecting wildlife like Moo Deng.
  */
...
contract MZ is ERC20, Ownable {
    ...
    constructor() ERC20("MooZoo", "MZ") payable {
        uint256 totalSupply = 1000000000 * 1e18;
        uint256 lpSupply = totalSupply.mul(100).div(100);

        maxSwapTxAmount = totalSupply.mul(175).div(10000);
        maxHoldings = totalSupply.mul(175).div(10000);
        feeThresholdAmount = totalSupply.mul(5).div(1000);

        feeAddr = 0x461971fc41596ba1812B3A55ed5dD6EEBFe355f9;
