...
/*
https://x.com/Tesla/status/190225166536266569122
*/
...
contract RoboRex is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Telsa New Dog Robot Model";
    string private constant _symbol = unicode"RoboRex";
    ...
    constructor(){
        _devWallet = payable(0x51EDaB642Cad99551D8f9cBdFF44F9f0563a0FC3);
    ...
    function makepairerc(uint256 _percentage) external onlyOwner() {
