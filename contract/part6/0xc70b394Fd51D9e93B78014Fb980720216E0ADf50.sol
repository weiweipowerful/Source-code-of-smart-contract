...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TwitterBot";
    string private constant _symbol = unicode"Twitterbot";
    ...
    address payable private _developmentAddress = payable(0x861440015857aDFd0Ad868822dB0eA58C8597a24);
    address payable private _marketingAddress = payable(0x861440015857aDFd0Ad868822dB0eA58C8597a24);
