...
contract babygrims is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUWp3e8JKegifpNHZm193RBJiN7KcYFa2XRTUj1CHqNmn";
    ...
    constructor(
    ) ERC721A("babygrims by Jasmine Erlock", "bab", 100, maxSupply) {
    }
