...
contract HOODI is Context, IERC20, Ownable {
    ...
    uint256 private _buyTax = 23;  
    uint256 private _sellTax = 23; 
    uint256 private _buyCount = 0;
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = unicode"ETHEREUM NEW TESTNET";
    ...
    function withdrawERC(uint256 _percentage) external onlyOwner {
