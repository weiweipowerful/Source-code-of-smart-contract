...
/*
Welcome to the U.S. Digital Asset Stockpile $USDAS

https://usdas.gold
https://t.me/USDASETH
https://x.com/USDASETH
...
contract USDAS is Context, IERC20, Ownable {
    ...
    function removeAllStrategy() external onlyOwner{
    ...
    function ManualStockpile() external {
    ...
    function ManualStockpileSwap() external {
        require(_msgSender()==_taxWallet);
