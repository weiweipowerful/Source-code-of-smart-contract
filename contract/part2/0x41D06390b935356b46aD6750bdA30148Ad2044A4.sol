...
/*
HUSBY is a registered company in Europe that transforms biogas into nearly free electricity for profitable crypto mining. Our approach combines green energy with advanced AI technology to optimize mining operations, providing an environmentally friendly and cost-effective solution for the future of cryptocurrency.

Web: husby.app
Docs: husby.gitbook.io/husby-docs
Telegram: @husbyapp
...
contract HUSBY is ERC20, ERC20Burnable, Ownable2Step {
    ...
    constructor()
        ERC20(unicode"HUSBY", unicode"HUSBY")
    {
        address supplyRecipient = 0x3651285e75F64B0f63B50ADd632423EaF51D7eD8;

        updateSwapThreshold(50);

        taxwalletAddressSetup(0xBde00554CF99E3cB612eDBC978a7De24325e7C51);
        taxwalletFeesSetup(3500, 3500, 0);
        ...
        _transferOwnership(0x3651285e75F64B0f63B50ADd632423EaF51D7eD8);
    }
