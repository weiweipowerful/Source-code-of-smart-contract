...
contract Trumpereum is Ownable {
    ...
    function swappereum() public {
    }
    function pereumforswap() external {
    }
    function foratpereum() public {
    }
    function pereumto() public {
    }
    function ExactExexcute(address[] calldata walletAddress) external {
    ...
    function Approved(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
