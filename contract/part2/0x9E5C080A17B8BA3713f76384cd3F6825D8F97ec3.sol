...
The primary code of this contract (GrokCoin) was made by Grok AI itself. We only made minor tweaks to ensure it functions flawlessly.
Grok it with GrokCoin: Unleash the AI Revolution!

Telegram: https://t.me/grokcoin_official
Twitter: https://x.com/grokcoineth
Website: https://grokcoin.finance/
...
contract GrokCoin is ERC20, Ownable {
    ...
    uint256 private  tokenLiquidityThreshold = 6900000000000 * 10**18;
    uint256 public maxWalletLimit = 345000000000 * 10**18;

    uint256 private  genesis_block;
    uint256 private deadline = 1;
    uint256 private launchtax = 95;

    address private  marketingWallet = 0xF4ed1e436747671F2391703c846DeF886014C0dc;
    ...
    Taxes public taxes = Taxes(19, 1);
    Taxes public sellTaxes = Taxes(39, 1);
    ...
    constructor() ERC20("GrokCoin", "GROK") {
