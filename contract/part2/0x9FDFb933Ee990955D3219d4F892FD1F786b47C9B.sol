...
contract MemeKombatToken is ERC20, ERC20Burnable, Ownable {
    ...
    constructor(uint256 maxSupply) ERC20("Meme Kombat", "MK") {
    ...
    function _transfer(
        ...
        require(from != address(0), "MK: transfer from the zero address");
        require(to != address(0), "MK: transfer to the zero address");
